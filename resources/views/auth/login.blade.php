<x-guest-layout>
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-300">Masuk ke akun Lungsurin kamu</p>
    </div>
    ...
    <!-- Google Login Button -->
    <a href="{{ route('google.login') }}" class="w-full flex items-center justify-center gap-3 py-3 px-4 bg-gray-800/60 border-2 border-gray-600 rounded-xl hover:border-indigo-500 hover:bg-gray-800/80 transition-all duration-200 shadow-sm hover:shadow-md group">
        ...
        <span class="text-white font-medium group-hover:text-indigo-200">Masuk dengan Google</span>
    </a>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-5">
        ...
        <div class="flex items-center justify-between">
            <label for="remember_me" class="inline-flex items-center cursor-pointer group">
                ...
                >
                <span class="ml-2 text-sm text-gray-300 group-hover:text-white transition">
                    Ingat saya
                </span>
            </label>
        ...
        <p class="text-center text-gray-300">
            Belum punya akun?
            <a href="{{ route('register') }}" class="text-indigo-400 font-semibold hover:underline ml-1">
                Daftar sekarang
            </a>
        </p>
    </form>
