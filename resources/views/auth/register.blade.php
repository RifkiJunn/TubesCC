<x-guest-layout>
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-500 dark:text-gray-400">Bergabung dengan komunitas Lungsurin</p>
    </div>
    ...
    <!-- Google Login Button -->
    <a href="{{ route('google.login') }}" class="w-full flex items-center justify-center gap-3 py-3 px-4 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200 shadow-sm hover:shadow-md group mb-5">
        ...
        <span class="text-gray-700 dark:text-gray-300 font-medium group-hover:text-gray-900 dark:group-hover:text-white">Daftar dengan Google</span>
    </a>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <p class="text-center text-gray-600 dark:text-gray-400">
            Sudah punya akun?
            <a href="{{ route('login') }}" class="text-indigo-600 dark:text-indigo-400 font-semibold hover:underline ml-1">
                Masuk di sini
            </a>
        </p>
    </form>
